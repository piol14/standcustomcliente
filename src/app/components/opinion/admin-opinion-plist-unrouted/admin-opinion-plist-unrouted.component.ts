 ...
 */
  ...
  getPage(): void {
    this.oOpinionAjaxService.getPage(this.oPaginatorState.rows, this.oPaginatorState.page, this.orderField, this.orderDirection,this.id_usuario,this.id_stand).subscribe({
